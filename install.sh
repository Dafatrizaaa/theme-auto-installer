...
if (( available_ram_mb < 1048 )); then
  echo -e "${RED}RAM yang tersedia kurang dari 2GB. Script tidak akan dijalankan.${NC}"
  exit 1
fi
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               LICENSY VINZ OFFC             [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
